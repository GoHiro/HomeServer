...
class SerialFinder:
    def __init__(self):
        self.function_serial_dict = {'IRLight': {'OperatingStatus': {'ON': '',
                                     ...
                                     'ErectricFan': {'OperatingStatus': {'ON': '',
                                                                         'OFF': ''},
                                                     'OperatingMode': {'ON': '',
                                                                       'OFF': ''},
        ...
        self.current_device_state = {
            'Fan C': {'OperatingStatus': 'OFF',
                      'OperatingMode': 'Stable',
                      'TemperatureSettingValue': '30',
                      'FanSpeed': '4'},
            'Light C': {'OperatingStatus': 'OFF'}
        }
    ...
    async def get_function_per_function_sequence(self, function_list):
        for func_seq in function_list:
            ...
            if function_value == await self.get_current_device_state(function_name):
                ...
                await self.call_strings_behavior(function_name, function_value)
                await self.update_current_device_state(function_name, function_value)
            elif function_value.isdecimal():
                await self.call_integer_behavior(function_name, function_value)
                await self.update_current_device_state(function_name, function_value)
    ...
    async def get_device_name_pared_serial_number(self):
        ...
        for dev_info in device_information:
            if dev_info['dev:SerialNumber'] == self.serial_number_in_current_sequence:
                device_name = dev_info['dev:DeviceName']
                break
        return device_name

    async def call_strings_behavior(self, function_name, function_value):
        set_serial = await self.get_function_serial_of_current_serial_number(function_name, function_value)
    ...
    async def get_function_serial_of_current_serial_number(self, function_name, function_value):
        checked_dict = self.function_serial_dict
        self.current_device_name = await self.get_device_name_pared_serial_number()
        serial_key = [self.current_device_name, function_name, function_value]
        # print(serial_key)
        # print(checked_dict)
    ...
    async def call_integer_behavior(self, function_name, function_value):
...
class IrRemocon:
    ...
    async def send_serial_for_appliance(self, set_serial):
        ...
        self.transmit(set_serial, self.ch4)
